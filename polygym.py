...
class Config:
    def __init__(self, is_debug):
        ...
        if is_debug:
            self.clang_exe =  '/home/s2136718/MLPC/llvm_root/llvm_build/bin/clang'
            self.clang_benchmark_exe = '/home/s2136718/MLPC/llvm_root/llvm_build/bin/clang'
        else:
            self.clang_exe = '/home/s2136718/MLPC/llvm_root/llvm_build/bin/clang'
            self.clang_benchmark_exe = '/home/s2136718/MLPC/llvm_root/llvm_build/bin/clang'
...
def islScheduleMap2IslScheduleTree(jsonp, isl_schedule_map):
    ...
    cmd = ["/usr/lib/jvm/java-1.8.0-openjdk-amd64/bin/java",
           "-Djava.library.path=" + polyite_dir + "/scala-isl-utils/libs",
           "-classpath",
           polyite_dir + "/polyite/bin:" + polyite_dir + "/chernikova/bin:" + polyite_dir + "/scala-isl-utils/bin:" + polyite_dir + "/polyite/libs/scala-library.jar:" + polyite_dir + "/isl/interface/isl-scala.jar:" + "/home/s2136718/IDE/eclipse/plugins/org.junit_4.12.0.v201504281640/junit.jar:" + "/home/s2136718/IDE/eclipse/plugins/org.hamcrest.core_1.3.0.v201303031735.jar:" + polyite_dir + "/polyite/libs/mpi.jar:" + polyite_dir + "/polyite/libs/commons-lang3-3.4/commons-lang3-3.4.jar:" + polyite_dir + "/polyite/libs/commons-lang3-3.4/commons-lang3-3.4-javadoc.jar:" + polyite_dir + "/polyite/libs/commons-math3-3.6.1/commons-math3-3.6.1.jar:" + polyite_dir + "/polyite/libs/commons-math3-3.6.1/commons-math3-3.6.1-javadoc.jar:" + polyite_dir + "/polyite/libs/commons-math3-3.6.1/commons-math3-3.6.1-sources.jar:" + polyite_dir + "/polyite/libs/commons-math3-3.6.1/commons-math3-3.6.1-tests.jar:" + polyite_dir + "/polyite/libs/commons-math3-3.6.1/commons-math3-3.6.1-test-sources.jar:" + polyite_dir + "/polyite/libs/commons-math3-3.6.1/commons-math3-3.6.1-tools.jar:" + polyite_dir + "/polyite/libs/scala-parser-combinators_2.11-1.0.3.jar",
...
def parse_args():
    ...
    compilation_params['include_dirs'] += ['/home/s2136718/MLPC/llvm_root/llvm_build/lib/clang/3.9.1/include']
