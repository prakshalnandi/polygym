...
polybench_invocations = {
    ...
    #'mvt' : ['', '--include_dirs', polyite_dir + '/polybench-c-4.1/utilities ' + polyite_dir + '/polybench-c-4.1/linear-algebra/kernels/mvt', '--source_files', polyite_dir + '/polybench-c-4.1/utilities/polybench.c ' + polyite_dir + '/polybench-c-4.1/linear-algebra/kernels/mvt/mvt.c', '--function_name', 'kernel_mvt', '--num_iterations', '500'],
